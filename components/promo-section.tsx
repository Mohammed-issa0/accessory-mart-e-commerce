      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
          ...
          <div className="bg-black text-white px-8 py-3 rounded-lg text-center">
            <span className="text-lg md:text-xl font-bold">الرمز: SA0</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">للطلبات +$399</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">للطلبات +$999</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">للطلبات +$1800</div>
            </div>
          </div>
        </div>
      </div>
